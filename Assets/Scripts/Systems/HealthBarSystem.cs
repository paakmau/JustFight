...
namespace JustFight {
    ...
    class HealthBarSystem : JobComponentSystem {
        ...
        [BurstCompile]
        struct ScaleHealthBarJob : IJobForEach<HealthBar, TankToFollow, NonUniformScale> {
            [ReadOnly] public ComponentDataFromEntity<Health> healthCmpts;
            public void Execute ([ReadOnly] ref HealthBar Cmpt, [ReadOnly] ref TankToFollow tankToFollowCmpt, ref NonUniformScale scaleCmpt) {
